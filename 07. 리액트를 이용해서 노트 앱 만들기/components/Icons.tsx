...
export const PinIcon = ({ className, isFilled=false }: { className?: string; isFilled?: boolean; }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className || "h-6 w-6"} viewBox="0 0 20 20" fill={isFilled ? "currentColor" : "none"} stroke="currentColor">
